...
func (c *authServiceClient) GetAccess(ctx context.Context, in *GetAccessReq, opts ...grpc.CallOption) (*GetAccessResp, error) {
	out := new(GetAccessResp)
	err := c.cc.Invoke(ctx, "/genproto.AuthService/GetAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetAccess(context.Context, *GetAccessReq) (*GetAccessResp, error) {
...
func _AuthService_GetAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.AuthService/GetAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAccess(ctx, req.(*GetAccessReq))
	}
